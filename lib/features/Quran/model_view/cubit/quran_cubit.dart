...
class QuranCubit extends Cubit<QuranState> {
  ...
  Future<void> loadQuranData() async {
    ...
    try {
      ...
      final String surahsJsonString = await rootBundle.loadString('assets/json/surahs.json');
  ...
  Future<List<Verse>> loadSurahVerses(int surahId) async {
    try {
      final String versesJsonString = await rootBundle.loadString('assets/json/quran.json');
