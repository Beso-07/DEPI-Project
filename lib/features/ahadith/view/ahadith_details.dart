          ...
          child: Padding(
              ...
              child: Container(
                ...
                width: double.infinity,
                 child: Row(
                            children: [
                              Text("رواه $title",style: const TextStyle(color: Colors.black,fontWeight: FontWeight.w900),),
                              const Spacer(),
                              const Text("100", style: TextStyle(color: Color.fromARGB(255, 126, 124, 124),
                             ...
                             child: Column(
                               children: [
                                 Container(
                                        ...
                                        Stack(
                                          children: [
                                            ...
                                            Positioned(
                                              right: 8,
                                              top: 5,
                                              child:  Text(Hadith.id.toString(),style: const TextStyle(fontWeight: FontWeight.w900,
                                  ...
                                  onPressed: () {
                                    Clipboard.setData(
                                        ClipboardData(text: Hadith.hadithContent));
                                  ...
                                  SizedBox(height: height * 0.02,),
                                    ...
                                    SizedBox(
                                      width: double.infinity,
                                      child: Text(Hadith.hadithContent,
